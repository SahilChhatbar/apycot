    ...
    <main className='bg-[#fff6d8] min-h-screen flex-shrink-0 p-4 relative'>
      <div className='flex gap-0 relative'>
        <div className='relative w-fit'>
          ...
          <div className='absolute top-3/5 left-2/9 transform -translate-x-1/2 -translate-y-1/2 space-y-2'>
            ...
            <button onClick={()=>navigate("/404")} type="button" className="text-white bg-[#ea6a12]
        ...
        <div className="flex flex-col w-2/3">
          <div className="flex items-center mb-4">
            ...
            <p className="ml-140 flex items-center text-sm">
              View All
              <button onClick={()=>navigate("/404")} className="text-white bg-[#ea6a12] rounded-full
