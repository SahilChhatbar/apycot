...
const Card2 = ({ image, title, rating, price }) => {
  return (
    ...
    <button className="absolute bottom-4 right-4 bg-orange-500 text-white w-6 h-6 rounded-full flex items-center justify-center shadow-md group-hover:bg-slate-200 group-hover:text-[#ea6a12]">
      <IoIosAdd size={18} />
    </button>
  </div>
  );
